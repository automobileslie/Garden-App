...
render() {
    return(
        ...
        {/* <img id="another-homepage-image" src={"http://candide.nypl.org/text/wp-content/uploads/2010/02/candidegarden-e1265986384504.jpg"} alt={"garden at the end of Voltaire's Candide"} /> */}
        </div>
    )
}
